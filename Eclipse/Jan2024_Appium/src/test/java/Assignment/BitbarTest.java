...
public class BitbarTest {
  ...
  public void f(String name) throws Exception {
	  ...
	  if(obj.isDisplayed()) {
		  ...
		  File dfile = new File("D:\\Training\\Eclipse\\Jan2024_Appium\\bitbidar.png");
  ...
  public Object[][] dp() throws Exception {
	  File f1 = new File("D:\\Training\\Eclipse\\Jan2024_Appium\\Bitbar.xlsx");
